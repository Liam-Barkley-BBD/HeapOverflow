...
public class ReplyServices {
    public static JsonNode getReplies(int page, int size) throws Exception {
        return HttpUtils
                    .syncGet(EnvUtils.getStringEnvOrThrow(EnvConstants.SERVER_URI) + ApiEndpointsConstants.API_REPLIES + "?page=" + page +"&size=" + size);
    }

    public static JsonNode getReplyById(String id) throws Exception {
        return HttpUtils
                    .syncGet(EnvUtils.getStringEnvOrThrow(EnvConstants.SERVER_URI) + ApiEndpointsConstants.API_REPLIES_ID + id);
    }
    ...
    public static JsonNode deleteReply(String id) throws Exception {
        return HttpUtils
                    .syncDelete(EnvUtils.getStringEnvOrThrow(EnvConstants.SERVER_URI) + ApiEndpointsConstants.API_REPLIES_ID + id);
    }
}
